...
namespace QM {
    ...
    inline const std::unordered_map<QM::QueueEvents, std::string> QueueEvents_str = {
        ...
        {QM::QueueEvents::ITEM_MODEL_HASH_START, "ITEM_MODEL_HASH_START"},
        {QM::QueueEvents::ITEM_MODEL_HASH_UPDATE, "ITEM_MODEL_HASH_UPDATE"},
        {QM::QueueEvents::ITEM_MODEL_HASH_DONE, "ITEM_MODEL_HASH_DONE"}};
