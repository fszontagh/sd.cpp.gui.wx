...
mainUI::mainUI( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style, const wxString& name ) : wxFrame( parent, id, title, pos, size, style, name )
{
	...
	m_notebook1302->AssignImageList( m_notebook1302Images );
	wxBitmap m_notebook1302Bitmap;
	wxImage m_notebook1302Image;
	...
	m_notebook1302Bitmap = images_png_to_wx_bitmap();
	...
	bSizer1029->Add( m_inpaintImageResolution, 1, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	...
	bSizer1022->Add( m_img2imPanel, 1, wxRESERVE_SPACE_EVEN_IF_HIDDEN|wxEXPAND, 0 );


	m_panel261->SetSizer( bSizer1022 );
	m_panel261->Layout();
	bSizer1022->Fit( m_panel261 );
	bSizer1026->Add( m_panel261, 1, wxEXPAND | wxALL, 5 );
	...
	m_inpaintCanvasTop = new wxTextCtrl( m_panel231, wxID_ANY, _("0"), wxDefaultPosition, wxSize( 40,-1 ), wxTE_PROCESS_ENTER|wxTE_RIGHT );
	...
	m_inpaintCanvasRight = new wxTextCtrl( m_panel231, wxID_ANY, _("0"), wxDefaultPosition, wxSize( 40,-1 ), wxTE_PROCESS_ENTER|wxTE_RIGHT );
	...
	m_inpaintCanvasBottom = new wxTextCtrl( m_panel231, wxID_ANY, _("0"), wxDefaultPosition, wxSize( 40,-1 ), wxTE_PROCESS_ENTER|wxTE_RIGHT );
	...
	m_inpaintCanvasLeft = new wxTextCtrl( m_panel231, wxID_ANY, _("0"), wxDefaultPosition, wxSize( 40,-1 ), wxTE_PROCESS_ENTER|wxTE_RIGHT );
	...
	bSizer28->Add( m_notebook4, 1, wxEXPAND, 5 );


	bSizer10099->Add( bSizer28, 1, wxEXPAND, 5 );
	...
	bSizer33->Add( m_strength, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	...
	bSizer10099->Add( bSizer33, 0, wxEXPAND, 5 );


	m_image2image_panel->SetSizer( bSizer10099 );
	m_image2image_panel->Layout();
	bSizer10099->Fit( m_image2image_panel );
	m_notebook1302->AddPage( m_image2image_panel, _("img2img"), false );
	m_notebook1302Bitmap = palette_png_to_wx_bitmap();
	if ( m_notebook1302Bitmap.Ok() )
	{
		m_notebook1302Image = m_notebook1302Bitmap.ConvertToImage();
		m_notebook1302Images->Add( m_notebook1302Image.Scale( m_notebook1302ImageSize.GetWidth(), m_notebook1302ImageSize.GetHeight() ) );
	...
	m_notebook1302Bitmap = picture_png_to_wx_bitmap();
	if ( m_notebook1302Bitmap.Ok() )
	{
		m_notebook1302Image = m_notebook1302Bitmap.ConvertToImage();
		m_notebook1302Images->Add( m_notebook1302Image.Scale( m_notebook1302ImageSize.GetWidth(), m_notebook1302ImageSize.GetHeight() ) );
	...
	m_imageInfoLoadTotxt = new wxButton( m_scrolledWindow7, wxID_ANY, _("Load all to txt2img"), wxDefaultPosition, wxDefaultSize, 0 );
	m_imageInfoLoadTotxt->Enable( false );

	bSizer112->Add( m_imageInfoLoadTotxt, 0, wxALL, 5 );

	m_imageInfoLoadToimg2img = new wxButton( m_scrolledWindow7, wxID_ANY, _("Load all to img2img"), wxDefaultPosition, wxDefaultSize, 0 );
	m_imageInfoLoadToimg2img->Enable( false );

	bSizer112->Add( m_imageInfoLoadToimg2img, 0, wxALL, 5 );
	...
	m_notebook1302Bitmap = interrogation_png_to_wx_bitmap();
	if ( m_notebook1302Bitmap.Ok() )
	{
		m_notebook1302Image = m_notebook1302Bitmap.ConvertToImage();
		m_notebook1302Images->Add( m_notebook1302Image.Scale( m_notebook1302ImageSize.GetWidth(), m_notebook1302ImageSize.GetHeight() ) );
	...
	m_notebook1302Bitmap = cube_png_to_wx_bitmap();
	if ( m_notebook1302Bitmap.Ok() )
	{
		m_notebook1302Image = m_notebook1302Bitmap.ConvertToImage();
		m_notebook1302Images->Add( m_notebook1302Image.Scale( m_notebook1302ImageSize.GetWidth(), m_notebook1302ImageSize.GetHeight() ) );
	...
	m_promptPanel = new wxPanel( m_promptAndFluxPanel, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL );
	wxBoxSizer* bSizer99;
	bSizer99 = new wxBoxSizer( wxVERTICAL );

	m_staticText73 = new wxStaticText( m_promptPanel, wxID_ANY, _("Prompt:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText73->Wrap( -1 );
	bSizer99->Add( m_staticText73, 0, wxALL, 5 );

	m_prompt = new wxStyledTextCtrl( m_promptPanel, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxBORDER_DEFAULT, wxEmptyString );
	m_prompt->SetUseTabs( false );
	m_prompt->SetTabWidth( 4 );
	m_prompt->SetIndent( 4 );
	m_prompt->SetTabIndents( false );
	m_prompt->SetBackSpaceUnIndents( false );
	m_prompt->SetViewEOL( false );
	m_prompt->SetViewWhiteSpace( false );
	m_prompt->SetMarginWidth( 2, 0 );
	m_prompt->SetIndentationGuides( false );
	m_prompt->SetReadOnly( false );
	m_prompt->SetMarginWidth( 1, 0 );
	m_prompt->SetMarginType( 0, wxSTC_MARGIN_NUMBER );
	m_prompt->SetMarginWidth( 0, m_prompt->TextWidth( wxSTC_STYLE_LINENUMBER, wxT("_99999") ) );
	m_prompt->MarkerDefine( wxSTC_MARKNUM_FOLDER, wxSTC_MARK_BOXPLUS );
	m_prompt->MarkerSetBackground( wxSTC_MARKNUM_FOLDER, wxColour( wxT("BLACK") ) );
	m_prompt->MarkerSetForeground( wxSTC_MARKNUM_FOLDER, wxColour( wxT("WHITE") ) );
	m_prompt->MarkerDefine( wxSTC_MARKNUM_FOLDEROPEN, wxSTC_MARK_BOXMINUS );
	m_prompt->MarkerSetBackground( wxSTC_MARKNUM_FOLDEROPEN, wxColour( wxT("BLACK") ) );
	m_prompt->MarkerSetForeground( wxSTC_MARKNUM_FOLDEROPEN, wxColour( wxT("WHITE") ) );
	m_prompt->MarkerDefine( wxSTC_MARKNUM_FOLDERSUB, wxSTC_MARK_EMPTY );
	m_prompt->MarkerDefine( wxSTC_MARKNUM_FOLDEREND, wxSTC_MARK_BOXPLUS );
	m_prompt->MarkerSetBackground( wxSTC_MARKNUM_FOLDEREND, wxColour( wxT("BLACK") ) );
	m_prompt->MarkerSetForeground( wxSTC_MARKNUM_FOLDEREND, wxColour( wxT("WHITE") ) );
	m_prompt->MarkerDefine( wxSTC_MARKNUM_FOLDEROPENMID, wxSTC_MARK_BOXMINUS );
	m_prompt->MarkerSetBackground( wxSTC_MARKNUM_FOLDEROPENMID, wxColour( wxT("BLACK") ) );
	m_prompt->MarkerSetForeground( wxSTC_MARKNUM_FOLDEROPENMID, wxColour( wxT("WHITE") ) );
	m_prompt->MarkerDefine( wxSTC_MARKNUM_FOLDERMIDTAIL, wxSTC_MARK_EMPTY );
	m_prompt->MarkerDefine( wxSTC_MARKNUM_FOLDERTAIL, wxSTC_MARK_EMPTY );
	m_prompt->SetSelBackground( true, wxSystemSettings::GetColour( wxSYS_COLOUR_HIGHLIGHT ) );
	...
	m_prompt2 = new wxStyledTextCtrl( m_promptPanel, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxBORDER_DEFAULT, wxEmptyString );
	m_prompt2->SetUseTabs( false );
	m_prompt2->SetTabWidth( 4 );
	m_prompt2->SetIndent( 4 );
	m_prompt2->SetTabIndents( false );
	m_prompt2->SetBackSpaceUnIndents( false );
	m_prompt2->SetViewEOL( false );
	m_prompt2->SetViewWhiteSpace( false );
	m_prompt2->SetMarginWidth( 2, 0 );
	m_prompt2->SetIndentationGuides( false );
	m_prompt2->SetReadOnly( false );
	m_prompt2->SetMarginWidth( 1, 0 );
	m_prompt2->SetMarginType( 0, wxSTC_MARGIN_NUMBER );
	m_prompt2->SetMarginWidth( 0, m_prompt2->TextWidth( wxSTC_STYLE_LINENUMBER, wxT("_99999") ) );
	m_prompt2->MarkerDefine( wxSTC_MARKNUM_FOLDER, wxSTC_MARK_BOXPLUS );
	m_prompt2->MarkerSetBackground( wxSTC_MARKNUM_FOLDER, wxColour( wxT("BLACK") ) );
	m_prompt2->MarkerSetForeground( wxSTC_MARKNUM_FOLDER, wxColour( wxT("WHITE") ) );
	m_prompt2->MarkerDefine( wxSTC_MARKNUM_FOLDEROPEN, wxSTC_MARK_BOXMINUS );
	m_prompt2->MarkerSetBackground( wxSTC_MARKNUM_FOLDEROPEN, wxColour( wxT("BLACK") ) );
	m_prompt2->MarkerSetForeground( wxSTC_MARKNUM_FOLDEROPEN, wxColour( wxT("WHITE") ) );
	m_prompt2->MarkerDefine( wxSTC_MARKNUM_FOLDERSUB, wxSTC_MARK_EMPTY );
	m_prompt2->MarkerDefine( wxSTC_MARKNUM_FOLDEREND, wxSTC_MARK_BOXPLUS );
	m_prompt2->MarkerSetBackground( wxSTC_MARKNUM_FOLDEREND, wxColour( wxT("BLACK") ) );
	m_prompt2->MarkerSetForeground( wxSTC_MARKNUM_FOLDEREND, wxColour( wxT("WHITE") ) );
	m_prompt2->MarkerDefine( wxSTC_MARKNUM_FOLDEROPENMID, wxSTC_MARK_BOXMINUS );
	m_prompt2->MarkerSetBackground( wxSTC_MARKNUM_FOLDEROPENMID, wxColour( wxT("BLACK") ) );
	m_prompt2->MarkerSetForeground( wxSTC_MARKNUM_FOLDEROPENMID, wxColour( wxT("WHITE") ) );
	m_prompt2->MarkerDefine( wxSTC_MARKNUM_FOLDERMIDTAIL, wxSTC_MARK_EMPTY );
	...
	m_neg_prompt = new wxStyledTextCtrl( m_promptPanel, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxBORDER_DEFAULT, wxEmptyString );
	m_neg_prompt->SetUseTabs( false );
	m_neg_prompt->SetTabWidth( 4 );
	m_neg_prompt->SetIndent( 4 );
	m_neg_prompt->SetTabIndents( false );
	m_neg_prompt->SetBackSpaceUnIndents( false );
	m_neg_prompt->SetViewEOL( false );
	m_neg_prompt->SetViewWhiteSpace( false );
	m_neg_prompt->SetMarginWidth( 2, 0 );
	m_neg_prompt->SetIndentationGuides( false );
	m_neg_prompt->SetReadOnly( false );
	m_neg_prompt->SetMarginWidth( 1, 0 );
	m_neg_prompt->SetMarginType( 0, wxSTC_MARGIN_NUMBER );
	m_neg_prompt->SetMarginWidth( 0, m_neg_prompt->TextWidth( wxSTC_STYLE_LINENUMBER, wxT("_99999") ) );
	m_neg_prompt->MarkerDefine( wxSTC_MARKNUM_FOLDER, wxSTC_MARK_BOXPLUS );
	m_neg_prompt->MarkerSetBackground( wxSTC_MARKNUM_FOLDER, wxColour( wxT("BLACK") ) );
	m_neg_prompt->MarkerSetForeground( wxSTC_MARKNUM_FOLDER, wxColour( wxT("WHITE") ) );
	m_neg_prompt->MarkerDefine( wxSTC_MARKNUM_FOLDEROPEN, wxSTC_MARK_BOXMINUS );
	m_neg_prompt->MarkerSetBackground( wxSTC_MARKNUM_FOLDEROPEN, wxColour( wxT("BLACK") ) );
	m_neg_prompt->MarkerSetForeground( wxSTC_MARKNUM_FOLDEROPEN, wxColour( wxT("WHITE") ) );
	m_neg_prompt->MarkerDefine( wxSTC_MARKNUM_FOLDERSUB, wxSTC_MARK_EMPTY );
	m_neg_prompt->MarkerDefine( wxSTC_MARKNUM_FOLDEREND, wxSTC_MARK_BOXPLUS );
	m_neg_prompt->MarkerSetBackground( wxSTC_MARKNUM_FOLDEREND, wxColour( wxT("BLACK") ) );
	m_neg_prompt->MarkerSetForeground( wxSTC_MARKNUM_FOLDEREND, wxColour( wxT("WHITE") ) );
	m_neg_prompt->MarkerDefine( wxSTC_MARKNUM_FOLDEROPENMID, wxSTC_MARK_BOXMINUS );
	m_neg_prompt->MarkerSetBackground( wxSTC_MARKNUM_FOLDEROPENMID, wxColour( wxT("BLACK") ) );
	m_neg_prompt->MarkerSetForeground( wxSTC_MARKNUM_FOLDEROPENMID, wxColour( wxT("WHITE") ) );
	m_neg_prompt->MarkerDefine( wxSTC_MARKNUM_FOLDERMIDTAIL, wxSTC_MARK_EMPTY );
	m_neg_prompt->MarkerDefine( wxSTC_MARKNUM_FOLDERTAIL, wxSTC_MARK_EMPTY );
	m_neg_prompt->SetSelBackground( true, wxSystemSettings::GetColour( wxSYS_COLOUR_HIGHLIGHT ) );
	...
	m_neg_prompt2 = new wxStyledTextCtrl( m_promptPanel, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxBORDER_DEFAULT, wxEmptyString );
	m_neg_prompt2->SetUseTabs( false );
	m_neg_prompt2->SetTabWidth( 4 );
	m_neg_prompt2->SetIndent( 4 );
	m_neg_prompt2->SetTabIndents( false );
	m_neg_prompt2->SetBackSpaceUnIndents( false );
	m_neg_prompt2->SetViewEOL( false );
	m_neg_prompt2->SetViewWhiteSpace( false );
	m_neg_prompt2->SetMarginWidth( 2, 0 );
	m_neg_prompt2->SetIndentationGuides( false );
	m_neg_prompt2->SetReadOnly( false );
	m_neg_prompt2->SetMarginWidth( 1, 0 );
	m_neg_prompt2->SetMarginType( 0, wxSTC_MARGIN_NUMBER );
	m_neg_prompt2->SetMarginWidth( 0, m_neg_prompt2->TextWidth( wxSTC_STYLE_LINENUMBER, wxT("_99999") ) );
	m_neg_prompt2->MarkerDefine( wxSTC_MARKNUM_FOLDER, wxSTC_MARK_BOXPLUS );
	m_neg_prompt2->MarkerSetBackground( wxSTC_MARKNUM_FOLDER, wxColour( wxT("BLACK") ) );
	m_neg_prompt2->MarkerSetForeground( wxSTC_MARKNUM_FOLDER, wxColour( wxT("WHITE") ) );
	m_neg_prompt2->MarkerDefine( wxSTC_MARKNUM_FOLDEROPEN, wxSTC_MARK_BOXMINUS );
	m_neg_prompt2->MarkerSetBackground( wxSTC_MARKNUM_FOLDEROPEN, wxColour( wxT("BLACK") ) );
	m_neg_prompt2->MarkerSetForeground( wxSTC_MARKNUM_FOLDEROPEN, wxColour( wxT("WHITE") ) );
	m_neg_prompt2->MarkerDefine( wxSTC_MARKNUM_FOLDERSUB, wxSTC_MARK_EMPTY );
	m_neg_prompt2->MarkerDefine( wxSTC_MARKNUM_FOLDEREND, wxSTC_MARK_BOXPLUS );
	m_neg_prompt2->MarkerSetBackground( wxSTC_MARKNUM_FOLDEREND, wxColour( wxT("BLACK") ) );
	m_neg_prompt2->MarkerSetForeground( wxSTC_MARKNUM_FOLDEREND, wxColour( wxT("WHITE") ) );
	m_neg_prompt2->MarkerDefine( wxSTC_MARKNUM_FOLDEROPENMID, wxSTC_MARK_BOXMINUS );
	m_neg_prompt2->MarkerSetBackground( wxSTC_MARKNUM_FOLDEROPENMID, wxColour( wxT("BLACK") ) );
	m_neg_prompt2->MarkerSetForeground( wxSTC_MARKNUM_FOLDEROPENMID, wxColour( wxT("WHITE") ) );
	m_neg_prompt2->MarkerDefine( wxSTC_MARKNUM_FOLDERMIDTAIL, wxSTC_MARK_EMPTY );
	m_neg_prompt2->MarkerDefine( wxSTC_MARKNUM_FOLDERTAIL, wxSTC_MARK_EMPTY );
	m_neg_prompt2->SetSelBackground( true, wxSystemSettings::GetColour( wxSYS_COLOUR_HIGHLIGHT ) );
	...
	m_promptPanel->SetSizer( bSizer99 );
	m_promptPanel->Layout();
	bSizer99->Fit( m_promptPanel );
	bSizer103->Add( m_promptPanel, 0, wxEXPAND | wxALL, 5 );

	m_fluxPanel = new wxPanel( m_promptAndFluxPanel, wxID_ANY, wxDefaultPosition, wxSize( -1,-1 ), wxBORDER_NONE|wxTAB_TRAVERSAL );
	wxGridSizer* gSizer4;
	...
	m_fluxPanel->Layout();
	gSizer4->Fit( m_fluxPanel );
	bSizer103->Add( m_fluxPanel, 0, wxALL|wxEXPAND, 0 );


	m_promptAndFluxPanel->SetSizer( bSizer103 );
	m_promptAndFluxPanel->Layout();
	...
	bSizer1041->SetMinSize( wxSize( 200,-1 ) );
	m_staticText161 = new wxStaticText( m_rightMainPanelScroll, wxID_ANY, _("VAE"), wxDefaultPosition, wxSize( -1,-1 ), wxALIGN_CENTER_HORIZONTAL );
	m_staticText161->Wrap( 0 );
	m_staticText161->SetFont( wxFont( wxNORMAL_FONT->GetPointSize(), wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD, false, wxEmptyString ) );
	...
	vaeOnCpu = new wxCheckBox( m_rightMainPanelScroll, wxID_ANY, _("CPU"), wxDefaultPosition, wxDefaultSize, 0 );
	vaeOnCpu->SetToolTip( _("VAE on CPU") );

	bSizer131->Add( vaeOnCpu, 1, wxALL|wxEXPAND, 5 );

	m_vae_tiling = new wxCheckBox( m_rightMainPanelScroll, wxID_ANY, _("Tiling"), wxDefaultPosition, wxDefaultSize, 0 );
	m_vae_tiling->SetToolTip( _("Process vae in tiles to reduce memory usage") );

	bSizer131->Add( m_vae_tiling, 1, wxALL|wxEXPAND, 5 );


	bSizer1041->Add( bSizer131, 0, wxEXPAND, 0 );

	m_vae_decode_only = new wxCheckBox( m_rightMainPanelScroll, wxID_ANY, _("Decode only"), wxDefaultPosition, wxDefaultSize, 0 );
	m_vae_decode_only->SetValue(true);
	m_vae_decode_only->Enable( false );

	bSizer1041->Add( m_vae_decode_only, 0, wxALL|wxEXPAND, 5 );

	m_staticline7 = new wxStaticLine( m_rightMainPanelScroll, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxLI_HORIZONTAL );
	bSizer1041->Add( m_staticline7, 0, wxEXPAND | wxALL, 5 );

	m_staticText234 = new wxStaticText( m_rightMainPanelScroll, wxID_ANY, _("CLIP"), wxDefaultPosition, wxSize( -1,-1 ), wxALIGN_CENTER_HORIZONTAL );
	m_staticText234->Wrap( 0 );
	m_staticText234->SetFont( wxFont( wxNORMAL_FONT->GetPointSize(), wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD, false, wxEmptyString ) );
	m_staticText234->SetToolTip( _("ignore last layers of CLIP network; 1 ignores none, 2 ignores one layer (default: -1)\n<= 0 represents unspecified, will be 1 for SD1.x, 2 for SD2.x") );

	bSizer1041->Add( m_staticText234, 0, wxALL|wxEXPAND, 5 );

	wxBoxSizer* bSizer129;
	bSizer129 = new wxBoxSizer( wxHORIZONTAL );

	clipOnCpu = new wxCheckBox( m_rightMainPanelScroll, wxID_ANY, _("CPU"), wxDefaultPosition, wxDefaultSize, 0 );
	clipOnCpu->SetToolTip( _("CLIP on CPU") );

	bSizer129->Add( clipOnCpu, 1, wxALL|wxEXPAND, 5 );

	m_clip_skip = new wxSpinCtrl( m_rightMainPanelScroll, wxID_ANY, wxT("0"), wxDefaultPosition, wxSize( -1,-1 ), wxALIGN_RIGHT|wxBORDER_DEFAULT, -1, 2, -1 );
	m_clip_skip->SetToolTip( _("ignore last layers of CLIP network; 1 ignores none, 2 ignores one layer (default: -1)\n<= 0 represents unspecified, will be 1 for SD1.x, 2 for SD2.x") );

	bSizer129->Add( m_clip_skip, 1, wxALL|wxEXPAND, 5 );


	bSizer1041->Add( bSizer129, 0, wxEXPAND, 0 );

	m_staticline9 = new wxStaticLine( m_rightMainPanelScroll, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxLI_HORIZONTAL );
	...
	m_staticline8 = new wxStaticLine( m_rightMainPanelScroll, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxLI_HORIZONTAL );
	bSizer1041->Add( m_staticline8, 0, wxEXPAND | wxALL, 5 );

	m_staticText233 = new wxStaticText( m_rightMainPanelScroll, wxID_ANY, _("SEED"), wxDefaultPosition, wxSize( -1,-1 ), wxALIGN_CENTER_HORIZONTAL );
	m_staticText233->Wrap( 0 );
	m_staticText233->SetFont( wxFont( wxNORMAL_FONT->GetPointSize(), wxFONTFAMILY_DEFAULT, wxFONTSTYLE_NORMAL, wxFONTWEIGHT_BOLD, false, wxEmptyString ) );

	bSizer1041->Add( m_staticText233, 0, wxALL|wxEXPAND, 0 );
	...
	bSizer1041->Add( m_sdXlres, 0, wxALL|wxEXPAND, 5 );
	...
	bSizer1041->Add( m_preset_list, 0, wxALL|wxEXPAND, 5 );

	wxBoxSizer* bSizer126;
	bSizer126 = new wxBoxSizer( wxHORIZONTAL );

	m_load_preset = new wxBitmapButton( m_rightMainPanelScroll, wxID_ANY, wxNullBitmap, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|0 );
	...
	m_save_preset = new wxBitmapButton( m_rightMainPanelScroll, wxID_ANY, wxNullBitmap, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|0 );
	...
	m_delete_preset = new wxBitmapButton( m_rightMainPanelScroll, wxID_ANY, wxNullBitmap, wxDefaultPosition, wxDefaultSize, wxBU_AUTODRAW|0 );

	m_delete_preset->SetBitmap( trash_png_to_wx_bitmap() );
	m_delete_preset->Enable( false );

	bSizer126->Add( m_delete_preset, 0, wxALL, 5 );


	bSizer1041->Add( bSizer126, 0, wxEXPAND, 0 );

	m_staticline3 = new wxStaticLine( m_rightMainPanelScroll, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxLI_HORIZONTAL );
	bSizer1041->Add( m_staticline3, 0, wxEXPAND | wxALL, 5 );

	wxBoxSizer* bSizer982;
	bSizer982 = new wxBoxSizer( wxVERTICAL );

	wxArrayString m_samplerChoices;
	m_sampler = new wxChoice( m_rightMainPanelScroll, wxID_ANY, wxDefaultPosition, wxSize( -1,-1 ), m_samplerChoices, 0 );
	m_sampler->SetSelection( 0 );
	m_sampler->SetToolTip( _("sampling method (default: \"euler_a\")") );

	bSizer982->Add( m_sampler, 1, wxALL|wxEXPAND, 5 );

	wxArrayString m_schedulerChoices;
	m_scheduler = new wxChoice( m_rightMainPanelScroll, wxID_ANY, wxDefaultPosition, wxSize( -1,-1 ), m_schedulerChoices, 0 );
	...
	bSizer982->Add( m_scheduler, 1, wxALL|wxEXPAND, 5 );


	bSizer1041->Add( bSizer982, 0, wxEXPAND, 0 );

	wxBoxSizer* bSizer101;
	bSizer101 = new wxBoxSizer( wxHORIZONTAL );

	m_staticText14 = new wxStaticText( m_rightMainPanelScroll, wxID_ANY, _("Steps:"), wxDefaultPosition, wxSize( -1,-1 ), 0 );
	m_staticText14->Wrap( -1 );
	m_staticText14->SetToolTip( _("number of sample steps (default: 20)") );

	bSizer101->Add( m_staticText14, 1, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	...
	wxBoxSizer* bSizer990;
	bSizer990 = new wxBoxSizer( wxHORIZONTAL );

	m_staticText15 = new wxStaticText( m_rightMainPanelScroll, wxID_ANY, _("Batch:"), wxDefaultPosition, wxSize( -1,-1 ), 0 );
	m_staticText15->Wrap( -1 );
	m_staticText15->SetToolTip( _("number of images to generate.") );

	bSizer990->Add( m_staticText15, 1, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	...
	m_staticText231 = new wxStaticText( m_rightMainPanelScroll, wxID_ANY, _("CFG:"), wxDefaultPosition, wxSize( -1,-1 ), 0 );
	m_staticText231->Wrap( 0 );
	bSizer1021->Add( m_staticText231, 1, wxALL|wxALIGN_CENTER_VERTICAL, 5 );
	...
	bSizer1121->Add( m_queue, 0, wxALL|wxEXPAND, 5 );
	...
	bSizer1121->Add( m_server, 0, wxALL|wxEXPAND, 5 );
	...
	this->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( mainUI::OnGlobalKeyDown ) );
	...
	m_img2imPanel->Connect( wxEVT_SIZE, wxSizeEventHandler( mainUI::OnImg2ImgSize ), NULL, this );
	m_inpaintCanvasTop->Connect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( mainUI::OnInpaintCanvasResizeApply ), NULL, this );
	m_inpaintCanvasRight->Connect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( mainUI::OnInpaintCanvasResizeApply ), NULL, this );
	m_inpaintCanvasBottom->Connect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( mainUI::OnInpaintCanvasResizeApply ), NULL, this );
	m_inpaintCanvasLeft->Connect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( mainUI::OnInpaintCanvasResizeApply ), NULL, this );
	...
	m_prompt->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( mainUI::OnPromptKeyDown ), NULL, this );
	m_prompt2->Connect( wxEVT_DROP_FILES, wxDropFilesEventHandler( mainUI::onTxt2ImgFileDrop ), NULL, this );
	m_prompt2->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( mainUI::OnPromptKeyDown ), NULL, this );
	...
	m_neg_prompt->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( mainUI::OnPromptKeyDown ), NULL, this );
	m_neg_prompt2->Connect( wxEVT_DROP_FILES, wxDropFilesEventHandler( mainUI::onTxt2ImgFileDrop ), NULL, this );
	m_neg_prompt2->Connect( wxEVT_KEY_DOWN, wxKeyEventHandler( mainUI::OnPromptKeyDown ), NULL, this );
...
mainUI::~mainUI()
{
	...
	this->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( mainUI::OnGlobalKeyDown ) );
	...
	m_img2imPanel->Disconnect( wxEVT_SIZE, wxSizeEventHandler( mainUI::OnImg2ImgSize ), NULL, this );
	m_inpaintCanvasTop->Disconnect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( mainUI::OnInpaintCanvasResizeApply ), NULL, this );
	m_inpaintCanvasRight->Disconnect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( mainUI::OnInpaintCanvasResizeApply ), NULL, this );
	m_inpaintCanvasBottom->Disconnect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( mainUI::OnInpaintCanvasResizeApply ), NULL, this );
	m_inpaintCanvasLeft->Disconnect( wxEVT_COMMAND_TEXT_ENTER, wxCommandEventHandler( mainUI::OnInpaintCanvasResizeApply ), NULL, this );
	...
	m_prompt->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( mainUI::OnPromptKeyDown ), NULL, this );
	m_prompt2->Disconnect( wxEVT_DROP_FILES, wxDropFilesEventHandler( mainUI::onTxt2ImgFileDrop ), NULL, this );
	m_prompt2->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( mainUI::OnPromptKeyDown ), NULL, this );
	...
	m_neg_prompt->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( mainUI::OnPromptKeyDown ), NULL, this );
	m_neg_prompt2->Disconnect( wxEVT_DROP_FILES, wxDropFilesEventHandler( mainUI::onTxt2ImgFileDrop ), NULL, this );
	m_neg_prompt2->Disconnect( wxEVT_KEY_DOWN, wxKeyEventHandler( mainUI::OnPromptKeyDown ), NULL, this );
...
Settings::Settings( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style, const wxString& name ) : wxFrame( parent, id, title, pos, size, style, name )
{
	...
	m_serversPanel = new wxPanel( m_notebook1696, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL );
	wxBoxSizer* bSizer103;
	bSizer103 = new wxBoxSizer( wxVERTICAL );
	...
	m_deleteServer = new wxButton( m_serversPanel, wxID_ANY, _("Delete"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer106->Add( m_deleteServer, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );

	m_serverEnable = new wxToggleButton( m_serversPanel, wxID_ANY, _("Enable"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer106->Add( m_serverEnable, 0, wxALL, 5 );
	...
	bSizer103->Add( bSizer105, 1, wxEXPAND, 5 );

	wxBoxSizer* bSizer104;
	bSizer104 = new wxBoxSizer( wxHORIZONTAL );

	m_staticText70 = new wxStaticText( m_serversPanel, wxID_ANY, _("Host:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText70->Wrap( -1 );
	bSizer104->Add( m_staticText70, 0, wxALL|wxALIGN_CENTER_VERTICAL, 5 );

	m_AddServerHost = new wxTextCtrl( m_serversPanel, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	m_AddServerHost->SetMinSize( wxSize( 180,-1 ) );

	bSizer104->Add( m_AddServerHost, 0, wxALL, 5 );

	m_staticText71 = new wxStaticText( m_serversPanel, wxID_ANY, _("Port:"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText71->Wrap( -1 );
	...
	{
	m_AddServerPort->SetMaxLength( 5 );
	}
	#else
	m_AddServerPort->SetMaxLength( 5 );
	#endif
	bSizer104->Add( m_AddServerPort, 0, wxALL, 5 );

	m_button18 = new wxButton( m_serversPanel, wxID_ANY, _("Add server"), wxDefaultPosition, wxDefaultSize, 0 );
	bSizer104->Add( m_button18, 0, wxALL, 5 );


	bSizer103->Add( bSizer104, 0, wxEXPAND, 5 );


	m_serversPanel->SetSizer( bSizer103 );
	m_serversPanel->Layout();
	bSizer103->Fit( m_serversPanel );
	m_notebook1696->AddPage( m_serversPanel, _("Servers"), false );
	...
	m_serverList->Connect( wxEVT_COMMAND_DATAVIEW_ITEM_EDITING_STARTED, wxDataViewEventHandler( Settings::OnServerListEditingStarted ), NULL, this );
	...
	m_button18->Connect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( Settings::OnAddServer ), NULL, this );
...
Settings::~Settings()
{
	...
	m_serverList->Disconnect( wxEVT_COMMAND_DATAVIEW_ITEM_EDITING_STARTED, wxDataViewEventHandler( Settings::OnServerListEditingStarted ), NULL, this );
	...
	m_button18->Disconnect( wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler( Settings::OnAddServer ), NULL, this );
