...
public:
    ...
    TreeListManager(wxTreeListCtrl* treeList) {
        ...
        this->treeListCtrl = treeList;
        this->treeListCtrl->SetItemComparator(comparator);
    }


    void AddItem(const sd_gui_utils::ModelFileInfo* item, bool select = false, sd_gui_utils::sdServer* server = nullptr) {
