...
if (SD_AVX)
    ...
    BUILD_BYPRODUCTS ${CMAKE_BINARY_DIR}/sdcpp_avx/bin/${CMAKE_FIND_LIBRARY_PREFIXES}stable-diffusion${CMAKE_SHARED_LIBRARY_SUFFIX}
...
if (SD_AVX2)
    ...
    BUILD_BYPRODUCTS ${CMAKE_BINARY_DIR}/sdcpp_avx2/bin/${CMAKE_FIND_LIBRARY_PREFIXES}stable-diffusion${CMAKE_SHARED_LIBRARY_SUFFIX}
...
if (SD_AVX512)
    ...
    BUILD_BYPRODUCTS ${CMAKE_BINARY_DIR}/sdcpp_avx512/bin/${CMAKE_FIND_LIBRARY_PREFIXES}stable-diffusion${CMAKE_SHARED_LIBRARY_SUFFIX}
...
if (SD_CUBLAS)
    ...
    INSTALL_COMMAND ${CMAKE_COMMAND} ARGS -E copy_if_different ${CMAKE_BINARY_DIR}/sdcpp_cuda/bin/${CMAKE_FIND_LIBRARY_PREFIXES}stable-diffusion${CMAKE_SHARED_LIBRARY_SUFFIX} ${SDCPP_CUDA_LIBRARY}
    ...
    BUILD_BYPRODUCTS ${CMAKE_BINARY_DIR}/sdcpp_cuda/bin/${CMAKE_FIND_LIBRARY_PREFIXES}stable-diffusion${CMAKE_SHARED_LIBRARY_SUFFIX}
...
if (SD_HIPBLAS)
    ...
    INSTALL_COMMAND ${CMAKE_COMMAND} ARGS -E copy_if_different ${CMAKE_BINARY_DIR}/sdcpp_rocm/bin/${CMAKE_FIND_LIBRARY_PREFIXES}stable-diffusion${CMAKE_SHARED_LIBRARY_SUFFIX} ${SDCPP_ROCM_LIBRARY}
    ...
    BUILD_BYPRODUCTS ${CMAKE_BINARY_DIR}/sdcpp_rocm/bin/${CMAKE_FIND_LIBRARY_PREFIXES}stable-diffusion${CMAKE_SHARED_LIBRARY_SUFFIX}
