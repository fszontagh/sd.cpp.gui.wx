...
install(TARGETS sd_ui DESTINATION bin COMPONENT "${CMAKE_PROJECT_NAME}")

#get_cmake_property(CPACK_COMPONENTS_ALL COMPONENTS)
list(REMOVE_ITEM CPACK_COMPONENTS_ALL "Unspecified")

if (SDGUI_AVX)
    list(APPEND CPACK_COMPONENTS_ALL "SD.CPP - avx")
endif()

if (SDGUI_AVX2)
    list(APPEND CPACK_COMPONENTS_ALL "SD.CPP - avx2")
endif()

if (SDGUI_AVX512)
    list(APPEND CPACK_COMPONENTS_ALL "SD.CPP - avx512")
endif()

if (SDGUI_CUDA)
    list(APPEND CPACK_COMPONENTS_ALL "SD.CPP - cuda")
endif()

if (SDGUI_ROCM)
    list(APPEND CPACK_COMPONENTS_ALL "SD.CPP - rocm")
endif()

if (SDGUI_VULKAN)
    list(APPEND CPACK_COMPONENTS_ALL "SD.CPP - vulkan")
endif()
