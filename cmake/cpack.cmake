...
if (SDGUI_CUBLAS OR EXISTS "${CMAKE_BINARY_DIR}/${EPREFIX}${CMAKE_SHARED_LIBRARY_PREFIX}libllama_cuda${CMAKE_SHARED_LIBRARY_SUFFIX}")
	install(FILES ${CMAKE_BINARY_DIR}/${EPREFIX}${CMAKE_SHARED_LIBRARY_PREFIX}libllama_cuda${CMAKE_SHARED_LIBRARY_SUFFIX}
	DESTINATION ${lib_INSTALL_PATH_NSIS}
...
if (SDGUI_HIPBLAS OR EXISTS "${CMAKE_BINARY_DIR}/${EPREFIX}${CMAKE_SHARED_LIBRARY_PREFIX}libllama_hipblas${CMAKE_SHARED_LIBRARY_SUFFIX}")
	install(FILES ${CMAKE_BINARY_DIR}/${EPREFIX}${CMAKE_SHARED_LIBRARY_PREFIX}libllama_hipblas${CMAKE_SHARED_LIBRARY_SUFFIX}
	DESTINATION ${lib_INSTALL_PATH_NSIS}
...
if (SDGUI_VULKAN OR EXISTS "${CMAKE_BINARY_DIR}/${EPREFIX}${CMAKE_SHARED_LIBRARY_PREFIX}libllama_vulkan${CMAKE_SHARED_LIBRARY_SUFFIX}")
	install(FILES ${CMAKE_BINARY_DIR}/${EPREFIX}${CMAKE_SHARED_LIBRARY_PREFIX}libllama_vulkan${CMAKE_SHARED_LIBRARY_SUFFIX}
	DESTINATION ${lib_INSTALL_PATH_NSIS}
